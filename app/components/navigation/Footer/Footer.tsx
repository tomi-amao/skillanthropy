...
export default function Footer() {
  ...
  return (
    <footer className=" text-baseSecondary pt-16 pb-8 px-8">
      <div className="container mx-auto px-6"></div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
        <div>
          <h3 className="text-2xl font-bold mb-6">Altruvist</h3>
          <p className="mb-6">
            Creating tangible, meaningful impact while rewarding volunteers and
            charities alike
          </p>
          <div className="flex space-x-4">
            ...
            <a
              href="https://github.com/altruvist-org"
              className="hover:text-accentPrimary transition-colors"
              aria-label="GitHub"
            >
              <svg
        ...
        <div>
          ...
          <motion.button
            ...
            className="bg-accentPrimary text-baseSecondary px-4 py-2 w-full rounded-lg hover:bg-accentPrimary/80"
